...
// boundary — the sync bundle stays 3D-free and the surface stays instant.
...
/** The interactive tmux surface needs a keyboard, so small touch screens land
 *  on Quiz mode. */
      ...
      <div className="mt-3 flex flex-col gap-3 sm:flex-row">
        ...
        >
          <span className="inline-flex items-center justify-center gap-2">
            <Emoji name="target" size={22} /> Prefix Rush
          </span>
        </button>
        <button
          onClick={() => {
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm text-ink-dim">
              This erases <b className="text-ink">all</b> progress — levels, XP, coins, streak and cosmetics — and
